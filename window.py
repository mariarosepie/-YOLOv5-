...
class MainWindow(QTabWidget):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("images/UI/dlmu.png"))
        # 图片读取进程
        ...
        self.model = self.model_load(weights="runs/train/exp14/weights/best.pt",
    ...
    ***界面初始化***
    ...
    def initUI(self):
        # 图片检测子界面
        font_title = QFont('楷体', 40)
        font_main = QFont('楷体', 20)
        # 图片识别界面, 两个按钮，上传图片和显示结果
        img_detection_widget = QWidget()
        img_detection_layout = QVBoxLayout()
        img_detection_title = QLabel("Picture Detection")
        ...
        up_img_button = QPushButton("Load")
        det_img_button = QPushButton("Start")
        up_img_button.clicked.connect(self.upload_img)
        det_img_button.clicked.connect(self.detect_img)
        up_img_button.setFont(font_main)
        det_img_button.setFont(font_main)
        up_img_button.setStyleSheet("QPushButton{color:yellow}"
        ...
        det_img_button.setStyleSheet("QPushButton{color:yellow}"
                                     "QPushButton:hover{background-color: rgb(2,110,180);}"
                                     "QPushButton{background-color:rgb(48,124,208)}"
                                     "QPushButton{border:2px}"
                                     "QPushButton{border-radius:5px}"
        ...
        self.webcam_detection_btn = QPushButton("Camera")
        self.mp4_detection_btn = QPushButton("Video")
        self.vid_stop_btn = QPushButton("Stop")
        self.webcam_detection_btn.setFont(font_main)
        self.mp4_detection_btn.setFont(font_main)
        self.vid_stop_btn.setFont(font_main)
        self.webcam_detection_btn.setStyleSheet("QPushButton{color:yellow}"
                                                "QPushButton:hover{background-color: rgb(2,110,180);}"
                                                "QPushButton{background-color:rgb(48,124,208)}"
                                                "QPushButton{border:2px}"
                                                "QPushButton{border-radius:5px}"
                                                "QPushButton{padding:5px 5px}"
                                                "QPushButton{margin:5px 5px}")
        self.mp4_detection_btn.setStyleSheet("QPushButton{color:yellow}"
                                             "QPushButton:hover{background-color: rgb(2,110,180);}"
                                             "QPushButton{background-color:rgb(48,124,208)}"
                                             "QPushButton{border:2px}"
                                             "QPushButton{border-radius:5px}"
                                             "QPushButton{padding:5px 5px}"
                                             "QPushButton{margin:5px 5px}")
        self.vid_stop_btn.setStyleSheet("QPushButton{color:yellow}"
                                        "QPushButton:hover{background-color: rgb(2,110,180);}"
                                        "QPushButton{background-color:rgb(48,124,208)}"
                                        "QPushButton{border:2px}"
                                        "QPushButton{border-radius:5px}"
        ...
        self.setTabIcon(0, QIcon('images/UI/dlmu.png'))
        self.setTabIcon(1, QIcon('images/UI/dlmu.png'))
    ...
    ***检测图片***
    ...
    def detect_img(self):
        ...
        print(source)
        if source == "":
            QMessageBox.warning(self, "Please load picture!", "Predict after load")
        else:
            source = str(source)
